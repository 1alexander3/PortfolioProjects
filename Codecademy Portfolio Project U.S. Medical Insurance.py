...
# Import csv libarary to read the csv file with medical insurance information
import csv
...
# Create empty lists for the columns in insurances.csv
ages = []
sexes = []
bmis = []
num_children = []
...
# Loading the list to look at the data
